...
# Measurement quality
The [Sweep](../manual/sweep_tool.md) tool displays plots with [Coherence Blanking](../manual/plot_setup.md#coherence-blanking).  Portions of the measurement that are above the selected signal to noise ratio will be displayed.  This is a helpful indicator of measurement quality.  
